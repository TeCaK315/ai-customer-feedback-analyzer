      ...
      <header className="border-b border-gray-800 bg-gray-900/50 backdrop-blur-xl sticky top-0 z-50">
        <div className="max-w-5xl mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="font-bold text-lg">AI Customer Feedback Analyzer</h1>
              <p className="text-xs text-gray-400">Transforming Customer Insights</p>
            </div>
          </div>
          <button
            ...
            <div className="relative">
              {inputType === 'text' ? (
                <textarea
                  ...
                  placeholder="Вставьте ссылку на Reddit пост, Product Hunt, или другой источник..."
                  rows={6}
